...
//  Routines
//
//  Created by Adriany Cocom on 8/8/19.
...
class SettingsTableViewController: UITableViewController, backgroundImageProtocol {
    
    //MARK: - My variables
    let sectionsData =  ["Information", "Background"]
    let rowsData = [["Version Number"], ["Change Background Image"]]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.section == 1 && indexPath.row == 0{
            performSegue(withIdentifier: "goToBackgroundImages", sender: self)
        }
    }
